...
public final class CQLUtilityClass {
  ...
  //            List<CQLQualityDataSetDTO> dtoList =
  ...
  //
  //
  //    private static List<CQLQualityDataSetDTO> convertCodesToQualityDataSetDTO(List<CQLCode>
  // codeList) {
  //        List<CQLQualityDataSetDTO> convertedCQLDataSetList = new
  // ArrayList<CQLQualityDataSetDTO>();
  ...
  //    }
  //
  //    public static List<CQLQualityDataSetDTO> sortCQLQualityDataSetDto(List<CQLQualityDataSetDTO>
  // cqlQualityDataSetDTOs) {
  //
  ...
  //    }
  //
  //    private static List<CQLQualityDataSetDTO> filterValuesets(List<CQLQualityDataSetDTO>
  // cqlValuesets) {
  //
  ...
  //                if (code.getCodeSystemOID() != null && !code.getCodeSystemOID().isEmpty() &&
  // !"null".equals(code.getCodeSystemOID())) {
  //                    boolean isUrlCodeSystem = StringUtils.startsWith(code.getCodeSystemOID(),
  // "http");
  //                    if (isUrlCodeSystem) {
  ...
  // code.getCodeSystemVersion().replaceAll(" ", "%20");
  //                            codeSysVersion = "version 'urn:hl7:version:" +
  ...
  //                    if (isFhir) {
  //                        sb.append("valueset
  // ").append('"').append(valueset.getName()).append('"');
  ...
  //                String codeSysStr = code.getCodeSystemName();
  //                if (code.isIsCodeSystemVersionIncluded()) {
  //                    codeSysStr = codeSysStr + ":" + code.getCodeSystemVersion().replaceAll(" ",
  // "%20");
  //                }
  //
