...
public class Cql2ElmListener extends cqlBaseListener {
    ...
    public Cql2ElmListener(CQLGraph graph, CompiledLibrary library, Map<String, CompiledLibrary> translatedLibraryMap,
    ...
    public Cql2ElmListener(String libraryIdentifier, CQLGraph graph,
...
//            return this.translatedLibraryMap.get(libraryAccessor.getPath() + "-" + libraryAccessor.getVersion());
    ...
    private boolean shouldResolve(String identifier) {
        // if the namespace contains the identifier, that means it's a local identifier and should not be treated
...
//        CompiledLibrary childLibrary = this.translatedLibraryMap.get(def.getPath() + "-" + def.getVersion());
        ...
        Cql2ElmListener listener = new Cql2ElmListener(def.getPath() + "-" + def.getVersion() + "|" + def.getLocalIdentifier() + "|", graph, childLibrary, translatedLibraryMap, childrenLibraries);
